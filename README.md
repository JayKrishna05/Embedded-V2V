SP32 V2V Collision Warning System (RSSI + ML)


A low-cost, real-time 
Vehicle-to-Vehicle (V2V) collision warning system built using ESP32, 
leveraging WiFi RSSI, Kalman filtering, and a lightweight machine 
learning model for distance estimation.
...
Task NameFunctionalityvTaskProcessRSSI → Distance → Kalman → TTCvTaskCommHTTP communication and data exchangevTaskDisplayOLED rendering and buzzer alerts
